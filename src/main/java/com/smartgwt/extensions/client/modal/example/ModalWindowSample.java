package com.smartgwt.extensions.client.modal.example;
...
import com.smartgwt.extensions.client.modal.ModalWindow;

public class ModalWindowSample implements EntryPoint {
